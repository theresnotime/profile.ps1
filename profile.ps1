...
function TabExpansion($line, $lastWord) {
    ...
    elseif (Test-Path Function:\togglTabExpansionBackup) {
        # Fall back on existing tab expansion
        togglTabExpansionBackup $line $lastWord
    }
}

[System.Environment]::SetEnvironmentVariable('PATH',$Env:PATH+';;C:\Users\Sam\Apps\go-ipfs_v0.11.0\go-ipfs')
